...
module_dir = os.path.join(__location__, "../src/genomicranges")
try:
...
try:
    from genomicranges import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "GenomicRanges-doc"
